/*
    테이블 생성은 Entity 를 통해서 자동으로 생성 하고 더미 데이터를 생성하는 INSERT 문
 */
...
/*
    IDX 컬럼의 KEY 값은 초기 Entity 에서 생성시 with 1로 생성되어 추가 적으로 데이터를 insert 할 시에 에러가나서 더미데이터상 100개 이후 101번으로 명시적으로
    변경한다.
 */
ALTER TABLE TB_BOARD ALTER COLUMN IDX RESTART WITH 102;

ALTER TABLE TB_USER ALTER COLUMN IDX RESTART WITH 2;
/*
    추가 유저 관련 테이블 더미 데이터
 */
INSERT INTO TB_USER ( IDX , USERNAME , PASSWORD , EMAIL , ADDRESS , PHONE_NUMBER)
VALUES (1 , '박종현' , '1234' , 'jonghyunpark@naver.com', '강북구 수유동' , '010-2950-6028')